...
help: ## Shows this message.
	@echo "Asynchronous Python client for the Fumis WiRCU API."; \
	echo; \
	echo "Usage:"; \
	awk -F ':|##' '/^[^\t].+?:.*?##/ {\
...
lint-black: ## Run linting using black & blacken-docs.
	black --safe --target-version py36 fumis tests examples; \
...
test: ## Run tests quickly with the default Python.
	pytest --cov-report html --cov-report term --cov=fumis .;
