"""Entry point shim for the optional Fumis CLI.
...
def main() -> None:
    ...
    try:
        ...
        from fumis.cli import cli  # noqa: PLC0415
        ...
        if missing_root not in _CLI_EXTRA_MODULES:
            raise
        msg = (
            "The Fumis CLI requires the 'cli' extra. "
            "Install it with: pip install 'fumis[cli]'"
        )
