...
[**Report a vulnerability**](https://github.com/frenck/python-fumis/security/advisories/new)
...
- Issues in the Fumis WiRCU device firmware itself; please report those
  directly to [Fumis](https://www.fumis.si/).
- Denial-of-service or data-exposure conditions resulting from malformed or
  hostile responses from the Fumis WiRCU API. This library assumes the
  configured endpoint is trusted.

## Scope

This security policy covers the `fumis` Python package published on
[PyPI](https://pypi.org/project/fumis/) and its source code in this
repository.
