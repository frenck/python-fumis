...
Comprehensive technical reference for the Fumis WiRCU cloud API, compiled
from observing network traffic from devices we own, publicly available
service manuals, community integrations, and real device fixtures.

---

## Legal Basis and Methodology

This research was conducted under multiple EU legal frameworks that
protect consumer rights, interoperability, and access to data from
devices you own.

### Applicable legislation

- **EU Software Directive (2009/24/EC, Article 6)**: Permits reverse
  engineering for interoperability purposes. Decompilation is allowed
  where it is indispensable to achieve interoperability of an
  independently created program with other programs. The CJEU has
  further ruled that decompilation to correct errors is permitted
  regardless of license restrictions.
- **EU Data Act (Regulation 2023/2854)**: Entered into force September
  2025. Gives users the right to access all data generated by their
  connected products, free of charge, in a machine-readable format.
  Manufacturers must enable users and authorized third parties to
  access this data. From September 2026, new connected products must
  be designed with data-access features built in.
- **GDPR (Regulation 2016/679)**: Grants data subjects the right to
  access their personal data (Article 15) and data portability
  (Article 20). Temperature, usage patterns, and operational data
  from a stove in your home constitute personal data.

### How this research was conducted

- **Observation of own devices**: All API traffic was captured from
  devices we own, on our own network. The WiRCU communicates with
  `api.fumis.si` over HTTPS. Observing the requests and responses
  your own device makes is within your rights as the device owner.
- **No circumvention of access controls**: The API uses simple MAC/PIN
  authentication provided to the device owner. No encryption was
  broken, no access controls were bypassed, and no systems were
  accessed without authorization.
- **Interoperability purpose**: The sole purpose of this work is to
  enable interoperability with home automation systems (e.g., Home
  Assistant) and home energy management systems. This is a protected
  purpose under the EU Software Directive.
- **Public sources**: Service manuals, community forum posts, and
  existing open-source integrations contributed to the understanding
  documented here.
- **No proprietary code**: This library is a clean-room
  implementation. It does not contain, copy, or distribute any
  proprietary code.

This project is not affiliated with, endorsed by, or supported by
Fumis (ATech elektronika d.o.o.) or any stove manufacturer.
